...
this._heartbeatCounter=heartbeatString===this._prevHeartbeatString?this._heartbeatCounter+1:1;this._prevHeartbeatString=heartbeatString;3<=this._heartbeatCounter?(utils_1.logger.log("[Tracing] Transaction finished because of no change for 3 heart beats"),this.setStatus("deadline_exceeded"),this.setTag(constants_1.FINISH_REASON_TAG,constants_1.IDLE_TRANSACTION_FINISH_REASONS[0]),this.finish()):this._pingHeartbeat()}};IdleTransaction.prototype._pingHeartbeat=function(){var _this=this;utils_1.logger.log("pinging Heartbeat -\x3e current counter: "+
this._heartbeatCounter);setTimeout(function(){_this._beat()},exports.HEARTBEAT_INTERVAL)};return IdleTransaction}(require.Transaction);exports.IdleTransaction=require}
