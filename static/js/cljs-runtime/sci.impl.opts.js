...
var len__5766__auto___73250 = arguments.length;
var i__5767__auto___73251 = (0);
while(true){
if((i__5767__auto___73251 < len__5766__auto___73250)){
args__5772__auto__.push((arguments[i__5767__auto___73251]));

var G__73252 = (i__5767__auto___73251 + (1));
i__5767__auto___73251 = G__73252;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq73240){
var G__73241 = cljs.core.first(seq73240);
var seq73240__$1 = cljs.core.next(seq73240);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__73241,seq73240__$1);
}));
...
var G__73253 = null;
var G__73253__1 = (function (msg){
return (new Error(msg));
});
var G__73253__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__73253__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__73253 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__73253__1.call(this,msg);
case 2:
return G__73253__2.call(this,msg,filename);
case 3:
return G__73253__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__73253.cljs$core$IFn$_invoke$arity$1 = G__73253__1;
G__73253.cljs$core$IFn$_invoke$arity$2 = G__73253__2;
G__73253.cljs$core$IFn$_invoke$arity$3 = G__73253__3;
return G__73253;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__73242_SHARP_){
return (new cljs.core.Delay(p1__73242_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__73243_SHARP_){
return (new goog.string.StringBuffer(p1__73243_SHARP_));
})], null)], null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__73244 = temp__5718__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73244,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73244,(1),null);
var G__73254 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__73255 = cljs.core.rest(kvs);
class__GT_opts = G__73254;
kvs = G__73255;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__73247){
var map__73248 = p__73247;
var map__73248__$1 = cljs.core.__destructure_map(map__73248);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var proxy_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"proxy-fn","proxy-fn",1116677438));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73248__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var map__73249 = opts;
var map__73249__$1 = cljs.core.__destructure_map(map__73249);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73249__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73249__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73249__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73249__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73249__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73249__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73249__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73249__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73249__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73249__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73249__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
