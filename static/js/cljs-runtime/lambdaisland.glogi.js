...
var G__58879 = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if((G__58879 == null)){
return null;
} else {
return lambdaisland.glogi.goog_setLevel(G__58879,lambdaisland.glogi.level(lvl));
}
});
/**
...
var seq__58880 = cljs.core.seq(lvls);
var chunk__58882 = null;
var count__58883 = (0);
var i__58884 = (0);
while(true){
if((i__58884 < count__58883)){
var vec__58892 = chunk__58882.cljs$core$IIndexed$_nth$arity$2(null,i__58884);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58892,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58892,(1),null);
var level_58921__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_58921__$1);


var G__58922 = seq__58880;
var G__58923 = chunk__58882;
var G__58924 = count__58883;
var G__58925 = (i__58884 + (1));
seq__58880 = G__58922;
chunk__58882 = G__58923;
count__58883 = G__58924;
i__58884 = G__58925;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq(seq__58880);
if(temp__5720__auto__){
var seq__58880__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__58880__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__58880__$1);
var G__58926 = cljs.core.chunk_rest(seq__58880__$1);
var G__58927 = c__5565__auto__;
var G__58928 = cljs.core.count(c__5565__auto__);
var G__58929 = (0);
seq__58880 = G__58926;
chunk__58882 = G__58927;
count__58883 = G__58928;
i__58884 = G__58929;
continue;
} else {
var vec__58895 = cljs.core.first(seq__58880__$1);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58895,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58895,(1),null);
var level_58930__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_58930__$1);


var G__58931 = cljs.core.next(seq__58880__$1);
var G__58932 = null;
var G__58933 = (0);
var G__58934 = (0);
seq__58880 = G__58931;
chunk__58882 = G__58932;
count__58883 = G__58933;
i__58884 = G__58934;
continue;
}
} else {
...
var temp__5720__auto___58935 = goog.debug.Console.instance;
if(cljs.core.truth_(temp__5720__auto___58935)){
var instance_58936 = temp__5720__auto___58935;
instance_58936.setCapturing(true);

var instance_58937__$1 = (new goog.debug.Console());
(goog.debug.Console.instance = instance_58937__$1);

instance_58937__$1.setCapturing();
} else {
}
...
var G__58898 = (new goog.debug.FancyWindow());
G__58898.setEnabled(true);
...
var G__58899 = (new goog.debug.DivConsole(element));
G__58899.setCapturing(true);
...
var len__5766__auto___58938 = arguments.length;
var i__5767__auto___58939 = (0);
while(true){
if((i__5767__auto___58939 < len__5766__auto___58938)){
args__5772__auto__.push((arguments[i__5767__auto___58939]));

var G__58940 = (i__5767__auto___58939 + (1));
i__5767__auto___58939 = G__58940;
continue;
} else {
}
break;
...
/** @this {Function} */
(lambdaisland.glogi.swap_handlers_BANG_.cljs$lang$applyTo = (function (seq58900){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58901,G__58902,seq58900__$2);
}));
...
var G__58906 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"sequenceNumber","sequenceNumber",-543983615),record.sequenceNumber_,new cljs.core.Keyword(null,"time","time",1385887882),record.time_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.lower_case(record.level_.name)),new cljs.core.Keyword(null,"message","message",-406056002),record.msg_,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927),record.loggerName_,new cljs.core.Keyword(null,"exception","exception",-335277064),record.exception_], null);
return (handler_fn.cljs$core$IFn$_invoke$arity$1 ? handler_fn.cljs$core$IFn$_invoke$arity$1(G__58906) : handler_fn.call(null,G__58906));
});
if(cljs.core.truth_(logger)){
var temp__5720__auto___58942 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5720__auto___58942)){
var handler_58943 = temp__5720__auto___58942;
lambdaisland.glogi.goog_removeHandler(logger,handler_58943);
} else {
}
...
return lambdaisland.glogi.goog_addHandler(G__58909,log_record_handler);
}
} else {
return null;
}
...
var logger = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if(cljs.core.truth_(logger)){
var temp__5720__auto___58945 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5720__auto___58945)){
var handler_58947 = temp__5720__auto___58945;
lambdaisland.glogi.goog_removeHandler(logger,handler_58947);
} else {
}
