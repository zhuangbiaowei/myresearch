...
var map__60517 = cljs.core.meta(iobj);
var map__60517__$1 = cljs.core.__destructure_map(map__60517);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60517__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60517__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__60517__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.vars.current_file));
...
var map__60520 = (function (){var or__5043__auto__ = stack;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
var G__60521 = env;
var G__60521__$1 = (((G__60521 == null))?null:cljs.core.deref(G__60521));
var G__60521__$2 = (((G__60521__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__60521__$1));
var G__60521__$3 = (((G__60521__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__60521__$2,id));
var G__60521__$4 = (((G__60521__$3 == null))?null:cljs.core.deref(G__60521__$3));
var G__60521__$5 = (((G__60521__$4 == null))?null:cljs.core.last(G__60521__$4));
if((G__60521__$5 == null)){
return null;
} else {
return cljs.core.meta(G__60521__$5);
}
}
})();
var map__60520__$1 = cljs.core.__destructure_map(map__60520);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60520__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60520__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60520__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var len__5766__auto___60536 = arguments.length;
var i__5767__auto___60537 = (0);
while(true){
if((i__5767__auto___60537 < len__5766__auto___60536)){
args__5772__auto__.push((arguments[i__5767__auto___60537]));

var G__60538 = (i__5767__auto___60537 + (1));
i__5767__auto___60537 = G__60538;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq60523){
var G__60524 = cljs.core.first(seq60523);
var seq60523__$1 = cljs.core.next(seq60523);
var G__60525 = cljs.core.first(seq60523__$1);
var seq60523__$2 = cljs.core.next(seq60523__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60524,G__60525,seq60523__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__60526 = cljs.core.namespace(sym);
switch (G__60526) {
case "clojure.core":
case "cljs.core":
...
return (new cljs.core.MapEntry((function (){var G__60527 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__60527) : inner.call(null,G__60527));
})(),(function (){var G__60528 = cljs.core.val(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__60528) : inner.call(null,G__60528));
})(),null));
} else {
...
var fexpr__60529 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__60529.cljs$core$IFn$_invoke$arity$2 ? fexpr__60529.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__60529.call(null,sci_ctx,form));
});
/**
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__60530_SHARP_){
return f(p1__60530_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__60531 = pred;
var G__60532 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__60531,G__60532) : sci.impl.utils.split_when.call(null,G__60531,G__60532));
})());
} else {
return null;
}
...
var G__60545 = cljs.core.next(params__$1);
var G__60546 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__60547 = lets;
params__$1 = G__60545;
new_params = G__60546;
lets = G__60547;
...
var G__60548 = cljs.core.next(params__$1);
var G__60549 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__60550 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__60548;
new_params = G__60549;
lets = G__60550;
continue;
...
var args__5772__auto__ = [];
var len__5766__auto___60555 = arguments.length;
var i__5767__auto___60556 = (0);
while(true){
if((i__5767__auto___60556 < len__5766__auto___60555)){
args__5772__auto__.push((arguments[i__5767__auto___60556]));

var G__60557 = (i__5767__auto___60556 + (1));
i__5767__auto___60556 = G__60557;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq60533){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq60533));
}));
