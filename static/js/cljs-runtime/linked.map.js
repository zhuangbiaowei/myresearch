...
(linked.map.Node.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k58951,else__5343__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k58951,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__58956){
var vec__58957 = p__58956;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58957,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58957,(1),null);
...
(linked.map.Node.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this58952,other58953){
var self__ = this;
var this58952__$1 = this;
return (((!((other58953 == null)))) && ((((this58952__$1.constructor === other58953.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58952__$1.value,other58953.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58952__$1.left,other58953.left)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58952__$1.right,other58953.right)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58952__$1.__extmap,other58953.__extmap)))))))))));
}));
...
(linked.map.Node.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k58951){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k58951);

}
}));

(linked.map.Node.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__58950){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__58961 = cljs.core.keyword_identical_QMARK_;
var expr__58962 = k__5349__auto__;
if(cljs.core.truth_((pred__58961.cljs$core$IFn$_invoke$arity$2 ? pred__58961.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__58962) : pred__58961.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__58962)))){
return (new linked.map.Node(G__58950,self__.left,self__.right,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__58961.cljs$core$IFn$_invoke$arity$2 ? pred__58961.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"left","left",-399115937),expr__58962) : pred__58961.call(null,new cljs.core.Keyword(null,"left","left",-399115937),expr__58962)))){
return (new linked.map.Node(self__.value,G__58950,self__.right,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__58961.cljs$core$IFn$_invoke$arity$2 ? pred__58961.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"right","right",-452581833),expr__58962) : pred__58961.call(null,new cljs.core.Keyword(null,"right","right",-452581833),expr__58962)))){
return (new linked.map.Node(self__.value,self__.left,G__58950,self__.__meta,self__.__extmap,null));
} else {
return (new linked.map.Node(self__.value,self__.left,self__.right,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__58950),null));
}
}
}
}));
...
(linked.map.Node.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__58950){
var self__ = this;
var this__5339__auto____$1 = this;
return (new linked.map.Node(self__.value,self__.left,self__.right,G__58950,self__.__extmap,self__.__hash));
}));
 ...
 */
linked.map.map__GT_Node = (function linked$map$map__GT_Node(G__58954){
var extmap__5382__auto__ = (function (){var G__58964 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__58954,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"left","left",-399115937),new cljs.core.Keyword(null,"right","right",-452581833)], 0));
if(cljs.core.record_QMARK_(G__58954)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__58964);
} else {
return G__58964;
}
})();
return (new linked.map.Node(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__58954),new cljs.core.Keyword(null,"left","left",-399115937).cljs$core$IFn$_invoke$arity$1(G__58954),new cljs.core.Keyword(null,"right","right",-452581833).cljs$core$IFn$_invoke$arity$1(G__58954),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
...
var self__ = this;
var coll = this;
return ["{",clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",(function (){var iter__5520__auto__ = (function linked$map$iter__58979(s__58980){
return (new cljs.core.LazySeq(null,(function (){
var s__58980__$1 = s__58980;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__58980__$1);
if(temp__5720__auto__){
var s__58980__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58980__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__58980__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__58982 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__58981 = (0);
while(true){
if((i__58981 < size__5519__auto__)){
var vec__58984 = cljs.core._nth(c__5518__auto__,i__58981);
...
cljs.core.chunk_append(b__58982,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(k)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v)].join(''));

var G__59056 = (i__58981 + (1));
i__58981 = G__59056;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58982),linked$map$iter__58979(cljs.core.chunk_rest(s__58980__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58982),null);
}
} else {
var vec__58987 = cljs.core.first(s__58980__$2);
...
return cljs.core.cons([cljs.core.str.cljs$core$IFn$_invoke$arity$1(k)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v)].join(''),linked$map$iter__58979(cljs.core.rest(s__58980__$2)));
}
} else {
return null;
}
...
var self__ = this;
var coll__$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58966_SHARP_,p2__58967_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(f,p1__58966_SHARP_),p2__58967_SHARP_);
...
var G__59058 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__59059 = cljs.core.next(es);
ret = G__59058;
es = G__59059;
continue;
} else {
...
var self__ = this;
var self__ = this;
var G__59011 = (arguments.length - (1));
switch (G__59011) {
case (1):
...
(linked.map.LinkedMap.prototype.apply = (function (self__,args58968){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args58968)));
}));
...
var vec__59027 = cljs.core.find(delegate_map,current);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59027,(0),null);
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59027,(1),null);
