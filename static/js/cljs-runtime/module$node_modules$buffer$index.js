...
Buffer.isBuffer(val)?val:utf8ToBytes((new Buffer(val,encoding)).toString()),code=val.length,encoding=0;encoding<end-start;++encoding)this[encoding+start]=val[encoding%code];return this};var INVALID_BASE64_RE=/[^+\/0-9A-Za-z-_]/g}
