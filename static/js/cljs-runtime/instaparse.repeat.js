...
var vec__97444 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97444,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97444,(1),null);
...
var vec__97447 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97447,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97447,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__97451 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97451,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97451,(1),null);
...
var G__97681 = cljs.core.next(parses__$1);
parses__$1 = G__97681;
continue;
}
...
var G__97465 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__97466 = G__97465;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97466,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97466,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97466,(2),null);
var selection = vec__97466;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__97465__$1 = G__97465;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__97473 = G__97465__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97473,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97473,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97473,(2),null);
var selection__$1 = vec__97473;
...
var G__97697 = cljs.core.long$(end__$1);
var G__97698 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__97699 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__97697;
parses__$1 = G__97698;
G__97465__$1 = G__97699;
continue;
...
var G__97496 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__97497 = G__97496;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97497,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97497,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97497,(2),null);
var selection = vec__97497;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__97496__$1 = G__97496;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__97503 = G__97496__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97503,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97503,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97503,(2),null);
var selection__$1 = vec__97503;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__97706 = cljs.core.long$(end__$1);
var G__97707 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__97708 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__97706;
parses__$1 = G__97707;
G__97496__$1 = G__97708;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__97512 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__97515 = G__97512;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97515,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97515,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97515,(2),null);
var selection = vec__97515;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__97512__$1 = G__97512;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__97530 = G__97512__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97530,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97530,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97530,(2),null);
var selection__$1 = vec__97530;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__97732 = cljs.core.long$(end__$1);
var G__97733 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__97734 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__97732;
parses__$1 = G__97733;
G__97512__$1 = G__97734;
continue;
...
if(cljs.core.truth_((function (){var fexpr__97551 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__97551.cljs$core$IFn$_invoke$arity$1 ? fexpr__97551.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__97551.call(null,output_format));
})())){
} else {
...
var G__97591 = output_format;
var G__97591__$1 = (((G__97591 instanceof cljs.core.Keyword))?G__97591.fqn:null);
switch (G__97591__$1) {
case "enlive":
...
var and__5041__auto____$1 = (function (){var G__97630 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__97629 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__97629.cljs$core$IFn$_invoke$arity$1 ? fexpr__97629.cljs$core$IFn$_invoke$arity$1(G__97630) : fexpr__97629.call(null,G__97630));
})();
