...
comment.length;comment="";var dosDate=file.dir;var date=file.date,JSCompiler_object_inline_crc32_4559=0,JSCompiler_object_inline_compressedSize_4560=0,JSCompiler_object_inline_uncompressedSize_4561=0;if(!streamedContent||streamingEnded)JSCompiler_object_inline_crc32_4559=streamInfo.crc32,JSCompiler_object_inline_compressedSize_4560=streamInfo.compressedSize,JSCompiler_object_inline_uncompressedSize_4561=streamInfo.uncompressedSize;streamInfo=0;streamedContent&&(streamInfo|=8);useCustomEncoding||!useUTF8ForFileName&&
...
utfEncodedFileName+=decToHex(dosDate,2);utfEncodedFileName+=decToHex(JSCompiler_object_inline_crc32_4559,4);utfEncodedFileName+=decToHex(JSCompiler_object_inline_compressedSize_4560,4);utfEncodedFileName+=decToHex(JSCompiler_object_inline_uncompressedSize_4561,4);utfEncodedFileName+=decToHex(encodedFileName.length,2);utfEncodedFileName+=decToHex(comment.length,2);compression=signature.LOCAL_FILE_HEADER+utfEncodedFileName+encodedFileName+comment;offset=signature.CENTRAL_FILE_HEADER+decToHex(platform,
