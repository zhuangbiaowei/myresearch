...
var G__78459 = clojure.zip.node(loc);
var fexpr__78458 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__78458.cljs$core$IFn$_invoke$arity$1 ? fexpr__78458.cljs$core$IFn$_invoke$arity$1(G__78459) : fexpr__78458.call(null,G__78459));
});
/**
...
var G__78462 = clojure.zip.node(loc);
var fexpr__78461 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__78461.cljs$core$IFn$_invoke$arity$1 ? fexpr__78461.cljs$core$IFn$_invoke$arity$1(G__78462) : fexpr__78461.call(null,G__78462));
} else {
...
var fexpr__78463 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__78463.cljs$core$IFn$_invoke$arity$2 ? fexpr__78463.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__78463.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__78464 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78464,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78464,(1),null);
var vec__78467 = clojure.zip.children(loc);
var seq__78468 = cljs.core.seq(vec__78467);
var first__78469 = cljs.core.first(seq__78468);
var seq__78468__$1 = cljs.core.next(seq__78468);
var c = first__78469;
var cnext = seq__78468__$1;
var cs = vec__78467;
...
var vec__78470 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78470,(0),null);
var map__78473 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78470,(1),null);
var map__78473__$1 = cljs.core.__destructure_map(map__78473);
var path = map__78473__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78473__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78473__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78473__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78473__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78473__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__78474 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78474,(0),null);
var map__78477 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78474,(1),null);
var map__78477__$1 = cljs.core.__destructure_map(map__78477);
var path = map__78477__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78477__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__78478 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78477__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__78479 = cljs.core.seq(vec__78478);
var first__78480 = cljs.core.first(seq__78479);
var seq__78479__$1 = cljs.core.next(seq__78479);
var r = first__78480;
var rnext = seq__78479__$1;
var rs = vec__78478;
...
var vec__78481 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78481,(0),null);
var map__78484 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78481,(1),null);
var map__78484__$1 = cljs.core.__destructure_map(map__78484);
var path = map__78484__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78484__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78484__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5041__auto__ = path;
if(cljs.core.truth_(and__5041__auto__)){
return r;
} else {
...
var vec__78485 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78485,(0),null);
...
var path = map__78488__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78488__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78488__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5041__auto__ = path;
if(cljs.core.truth_(and__5041__auto__)){
...
var vec__78489 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78489,(0),null);
var map__78492 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78489,(1),null);
var map__78492__$1 = cljs.core.__destructure_map(map__78492);
var path = map__78492__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78492__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78492__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5041__auto__ = path;
if(cljs.core.truth_(and__5041__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__78495 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78495,(0),null);
var map__78498 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78495,(1),null);
var map__78498__$1 = cljs.core.__destructure_map(map__78498);
var path = map__78498__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78498__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__78499 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78499,(0),null);
var map__78502 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78499,(1),null);
var map__78502__$1 = cljs.core.__destructure_map(map__78502);
var path = map__78502__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78502__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__78503 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78503,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78503,(1),null);
...
var len__5766__auto___78525 = arguments.length;
var i__5767__auto___78526 = (0);
while(true){
if((i__5767__auto___78526 < len__5766__auto___78525)){
args__5772__auto__.push((arguments[i__5767__auto___78526]));

var G__78528 = (i__5767__auto___78526 + (1));
i__5767__auto___78526 = G__78528;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq78506){
var G__78507 = cljs.core.first(seq78506);
var seq78506__$1 = cljs.core.next(seq78506);
var G__78508 = cljs.core.first(seq78506__$1);
var seq78506__$2 = cljs.core.next(seq78506__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__78507,G__78508,seq78506__$2);
}));
...
var G__78535 = clojure.zip.rightmost(child);
loc__$1 = G__78535;
continue;
} else {
return loc__$1;
...
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78517__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78517__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78517__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__78539 = clojure.zip.rightmost(child);
loc__$1 = G__78539;
continue;
} else {
return loc__$1;
