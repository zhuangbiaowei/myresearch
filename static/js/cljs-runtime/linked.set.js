...
var self__ = this;
var coll__$1 = this;
return ((cljs.core.set_QMARK_(other)) && ((((cljs.core.count(coll__$1) === cljs.core.count(other))) && (cljs.core.every_QMARK_((function (p1__59064_SHARP_){
return cljs.core.contains_QMARK_(coll__$1,p1__59064_SHARP_);
}),other)))));
}));
...
var self__ = this;
var self__ = this;
var G__59077 = (arguments.length - (1));
switch (G__59077) {
case (1):
...
(linked.set.LinkedSet.prototype.apply = (function (self__,args59067){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args59067)));
}));
