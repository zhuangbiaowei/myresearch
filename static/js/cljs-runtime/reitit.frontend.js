...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__77427_SHARP_){
return q.get(p1__77427_SHARP_);
})),q.getKeys()));
});
/**
...
if(cljs.core.every_QMARK_((function (p1__77440_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__77440_SHARP_);
