shadow$provide.module$node_modules$$pixi$loaders$dist$cjs$loaders=function(global,require,module,exports){function _addSignalBinding(self,node){self._head?(self._tail._next=node,node._prev=self._tail):self._head=node;self._tail=node;node._owner=self;return node}function parseUri(str,opts){opts=opts||{};var JSCompiler_object_inline_key_4580="source protocol authority userInfo user password host port relative path directory file query anchor".split(" ");str={strict:/^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/,
loose:/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/}[opts.strictMode?"strict":"loose"].exec(str);var uri={};for(opts=14;opts--;)uri[JSCompiler_object_inline_key_4580[opts]]=str[opts]||"";uri.queryKey={};uri[JSCompiler_object_inline_key_4580[12]].replace(/(?:^|&)([^&=]*)=?([^&]*)/g,function(_t0,t1,t2){t1&&(uri.queryKey[t1]=t2)});return uri}function _noop(){}
