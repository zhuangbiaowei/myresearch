...
var G__97437 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__97437)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__97437)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__97437)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__97437)].join('')));
...
var G__97673 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__97674 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__97673;
v = G__97674;
continue;
} else {
var G__97675 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__97676 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__97675;
v = G__97676;
continue;
}
...
break;
case "\"":
var G__97677 = cljs.core.next(sq);
var G__97678 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__97677;
v = G__97678;
continue;
...
break;
default:
var G__97679 = cljs.core.next(sq);
var G__97680 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__97679;
v = G__97680;
continue;
...
while(true){
var G__97514 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__97514__$1 = (((G__97514 instanceof cljs.core.Keyword))?G__97514.fqn:null);
switch (G__97514__$1) {
case "rule":
var vec__97518 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97518,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__97518,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__97524 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__97524) : instaparse.cfg.content.call(null,G__97524));
...
break;
case "paren":
var G__97702 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__97702;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__97528 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__97528) : instaparse.cfg.build_rule.call(null,G__97528));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__97533 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__97533) : instaparse.cfg.build_rule.call(null,G__97533));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__97534 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__97534) : instaparse.cfg.build_rule.call(null,G__97534));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__97535 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__97535) : instaparse.cfg.build_rule.call(null,G__97535));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__97536 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__97536) : instaparse.cfg.build_rule.call(null,G__97536));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__97537 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__97537) : instaparse.cfg.build_rule.call(null,G__97537));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__97514__$1)].join('')));
...
while(true){
var G__97540 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__97705 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__97705;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__97540__$1)].join('')));
...
var valid_nts_97710 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__97543_97711 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__97544_97712 = null;
var count__97545_97713 = (0);
var i__97546_97714 = (0);
while(true){
if((i__97546_97714 < count__97545_97713)){
var nt_97715 = chunk__97544_97712.cljs$core$IIndexed$_nth$arity$2(null,i__97546_97714);
if(cljs.core.truth_((valid_nts_97710.cljs$core$IFn$_invoke$arity$1 ? valid_nts_97710.cljs$core$IFn$_invoke$arity$1(nt_97715) : valid_nts_97710.call(null,nt_97715)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_97715),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__97716 = seq__97543_97711;
var G__97717 = chunk__97544_97712;
var G__97718 = count__97545_97713;
var G__97719 = (i__97546_97714 + (1));
seq__97543_97711 = G__97716;
chunk__97544_97712 = G__97717;
count__97545_97713 = G__97718;
i__97546_97714 = G__97719;
continue;
} else {
var temp__5720__auto___97720 = cljs.core.seq(seq__97543_97711);
if(temp__5720__auto___97720){
var seq__97543_97721__$1 = temp__5720__auto___97720;
if(cljs.core.chunked_seq_QMARK_(seq__97543_97721__$1)){
var c__5565__auto___97722 = cljs.core.chunk_first(seq__97543_97721__$1);
var G__97723 = cljs.core.chunk_rest(seq__97543_97721__$1);
var G__97724 = c__5565__auto___97722;
var G__97725 = cljs.core.count(c__5565__auto___97722);
var G__97726 = (0);
seq__97543_97711 = G__97723;
chunk__97544_97712 = G__97724;
count__97545_97713 = G__97725;
i__97546_97714 = G__97726;
continue;
} else {
var nt_97727 = cljs.core.first(seq__97543_97721__$1);
if(cljs.core.truth_((valid_nts_97710.cljs$core$IFn$_invoke$arity$1 ? valid_nts_97710.cljs$core$IFn$_invoke$arity$1(nt_97727) : valid_nts_97710.call(null,nt_97727)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_97727),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__97728 = cljs.core.next(seq__97543_97721__$1);
var G__97729 = null;
var G__97730 = (0);
var G__97731 = (0);
seq__97543_97711 = G__97728;
chunk__97544_97712 = G__97729;
count__97545_97713 = G__97730;
i__97546_97714 = G__97731;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__97547_97735 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__97548_97736 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__97549_97737 = true;
var _STAR_print_fn_STAR__temp_val__97550_97738 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__97549_97737);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__97550_97738);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__97548_97736);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__97547_97735);
}
...
var len__5766__auto___97740 = arguments.length;
var i__5767__auto___97741 = (0);
while(true){
if((i__5767__auto___97741 < len__5766__auto___97740)){
args__5772__auto__.push((arguments[i__5767__auto___97741]));

var G__97742 = (i__5767__auto___97741 + (1));
i__5767__auto___97741 = G__97742;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__97579){
var map__97580 = p__97579;
var map__97580__$1 = cljs.core.__destructure_map(map__97580);
var opts = map__97580__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__97581 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__97582 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__97582);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__5687__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__97592_97746 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__97593_97747 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__97594_97748 = true;
var _STAR_print_fn_STAR__temp_val__97595_97749 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__97594_97748);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__97595_97749);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__97593_97747);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__97592_97746);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5687__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__97581);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq97557){
var G__97558 = cljs.core.first(seq97557);
var seq97557__$1 = cljs.core.next(seq97557);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__97558,seq97557__$1);
}));
