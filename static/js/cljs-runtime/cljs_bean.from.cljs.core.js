...
var G__49585 = cljs.core.next(xs);
var G__49586 = cljs.core.next(ys);
xs = G__49585;
ys = G__49586;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__49519 = val;
var G__49520 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49519,G__49520) : f.call(null,G__49519,G__49520));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__49521 = val__$1;
var G__49522 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49521,G__49522) : f.call(null,G__49521,G__49522));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__49523 = val__$1;
var G__49524 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49523,G__49524) : f.call(null,G__49523,G__49524));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__49608 = cljs.core.next(es);
var G__49609 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__49608;
tcoll__$1 = G__49609;
continue;
} else {
...
var G__49612 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__49613 = cljs.core.next(es);
ret = G__49612;
es = G__49613;
continue;
} else {
