...
var len__5766__auto___42800 = arguments.length;
var i__5767__auto___42801 = (0);
while(true){
if((i__5767__auto___42801 < len__5766__auto___42800)){
args__5772__auto__.push((arguments[i__5767__auto___42801]));

var G__42802 = (i__5767__auto___42801 + (1));
i__5767__auto___42801 = G__42802;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__42717_42803 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__42718_42804 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__42719_42805 = true;
var _STAR_print_fn_STAR__temp_val__42720_42806 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__42719_42805);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__42720_42806);

try{var _STAR_print_level_STAR__orig_val__42721_42807 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42722_42808 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42722_42808);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42721_42807);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__42718_42804);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__42717_42803);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq42716){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq42716));
}));
...
var new_formatters = current_formatters.filter((function (p1__42771_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__42771_SHARP_)));
}));
...
var G__42777_42816 = f;
var target__40408__auto___42817 = G__42777_42816;
if(cljs.core.truth_(target__40408__auto___42817)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42777_42816)].join(''),"\n","target__40408__auto__"].join('')));
}

(target__40408__auto___42817["toString"] = (function (){
...
var G__42781_42818 = "%c%s";
var G__42782_42819 = "color:transparent";
var G__42783_42820 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__42781_42818,G__42782_42819,G__42783_42820) : f.call(null,G__42781_42818,G__42782_42819,G__42783_42820));
...
var args__5772__auto__ = [];
var len__5766__auto___42824 = arguments.length;
var i__5767__auto___42825 = (0);
while(true){
if((i__5767__auto___42825 < len__5766__auto___42824)){
args__5772__auto__.push((arguments[i__5767__auto___42825]));

var G__42826 = (i__5767__auto___42825 + (1));
i__5767__auto___42825 = G__42826;
continue;
} else {
}
break;
...
var vec__42790 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42790,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42790,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__42828__delegate = function (add_fmt,add_args){
...
var G__42828 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__42829__i = 0, G__42829__a = new Array(arguments.length -  1);
while (G__42829__i < G__42829__a.length) {G__42829__a[G__42829__i] = arguments[G__42829__i + 1]; ++G__42829__i;}
  add_args = new cljs.core.IndexedSeq(G__42829__a,0,null);
} 
return G__42828__delegate.call(this,add_fmt,add_args);};
G__42828.cljs$lang$maxFixedArity = 1;
G__42828.cljs$lang$applyTo = (function (arglist__42830){
var add_fmt = cljs.core.first(arglist__42830);
var add_args = cljs.core.rest(arglist__42830);
return G__42828__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq42785){
var G__42786 = cljs.core.first(seq42785);
var seq42785__$1 = cljs.core.next(seq42785);
var G__42787 = cljs.core.first(seq42785__$1);
var seq42785__$2 = cljs.core.next(seq42785__$1);
var G__42788 = cljs.core.first(seq42785__$2);
var seq42785__$3 = cljs.core.next(seq42785__$2);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42786,G__42787,G__42788,seq42785__$3);
}));
...
var seq__42793 = cljs.core.seq(features);
var chunk__42794 = null;
var count__42795 = (0);
var i__42796 = (0);
while(true){
if((i__42796 < count__42795)){
var feature = chunk__42794.cljs$core$IIndexed$_nth$arity$2(null,i__42796);
...
var G__42831 = seq__42793;
var G__42832 = chunk__42794;
var G__42833 = count__42795;
var G__42834 = (i__42796 + (1));
seq__42793 = G__42831;
chunk__42794 = G__42832;
count__42795 = G__42833;
i__42796 = G__42834;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq(seq__42793);
if(temp__5720__auto__){
var seq__42793__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__42793__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__42793__$1);
var G__42835 = cljs.core.chunk_rest(seq__42793__$1);
var G__42836 = c__5565__auto__;
var G__42837 = cljs.core.count(c__5565__auto__);
var G__42838 = (0);
seq__42793 = G__42835;
chunk__42794 = G__42836;
count__42795 = G__42837;
i__42796 = G__42838;
continue;
} else {
var feature = cljs.core.first(seq__42793__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__42839 = cljs.core.next(seq__42793__$1);
var G__42840 = null;
var G__42841 = (0);
var G__42842 = (0);
seq__42793 = G__42839;
chunk__42794 = G__42840;
count__42795 = G__42841;
i__42796 = G__42842;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5718__auto__)){
var o42799 = temp__5718__auto__;
return (o42799["version"]);
} else {
return null;
}
})() == null);
