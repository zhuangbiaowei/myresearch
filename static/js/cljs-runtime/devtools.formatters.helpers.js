...
var G__41279 = devtools.prefs.pref(v);
v = G__41279;
continue;
} else {
return v;
...
}catch (e41237){var _e__40417__auto__ = e41237;
return false;
}})();
...
}catch (e41242){var _e__40417__auto__ = e41242;
return false;
}})();
...
}catch (e41246){var _e__40417__auto__ = e41246;
return false;
}}
}
});
...
var vec__41255 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41255,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41255,(1),null);
...
return cljs.core.some((function (p1__41261_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41261_SHARP_);
}),template);
});
