...
var map__40555 = top_item;
var map__40555__$1 = cljs.core.__destructure_map(map__40555);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40555__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40555__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40555__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e40554){var _e = e40554;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___40599 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5718__auto___40599)){
var seen_errors_40600 = temp__5718__auto___40599;
if(cljs.core.truth_(seen_errors_40600.has(self))){
} else {
seen_errors_40600.add(self);

var temp__5720__auto___40601 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5720__auto___40601)){
var sense_40603 = temp__5720__auto___40601;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40603)].join(''));
} else {
}
}
} else {
