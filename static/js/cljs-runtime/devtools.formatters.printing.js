...
var len__5766__auto___41413 = arguments.length;
var i__5767__auto___41414 = (0);
while(true){
if((i__5767__auto___41414 < len__5766__auto___41413)){
args__5772__auto__.push((arguments[i__5767__auto___41414]));

var G__41415 = (i__5767__auto___41414 + (1));
i__5767__auto___41414 = G__41415;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41292){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41293,G__41294,seq41292__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41311_SHARP_){
return (!((cljs.core.meta(p1__41311_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41361__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41365){var _e__40417__auto__ = e41365;
return false;
}})();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
...
}catch (e41372){var _e__40417__auto__ = e41372;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41385 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41386 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41386);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41387__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41385);
}});
...
var temp__5718__auto___41444 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5718__auto___41444)){
var managed_print_level_41445 = temp__5718__auto___41444;
var _STAR_print_level_STAR__orig_val__41392_41446 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41393_41447 = managed_print_level_41445;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41393_41447);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41388_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41388_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41392_41446);
}} else {
job_fn();
}
