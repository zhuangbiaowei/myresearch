...
!0),this.parent.scale.x*=this.parent.scale.y/width,height=this.parent.worldScreenHeight,this.parent.emit("zoomed",{viewport:this.parent,type:"clamp-zoom"}));null!==this.options.maxHeight&&height>this.options.maxHeight&&(width=this.parent.scale.y,this.parent.fitHeight(this.options.maxHeight,!1,!1,!0),this.parent.scale.x*=this.parent.scale.y/width,this.parent.emit("zoomed",{viewport:this.parent,type:"clamp-zoom"}))}else if(this.options.minScale||this.options.maxScale){var JSCompiler_object_inline_y_4584=
width=null,JSCompiler_object_inline_y_4586=height=null;"number"===typeof this.options.minScale?JSCompiler_object_inline_y_4584=width=this.options.minScale:null!==this.options.minScale&&(JSCompiler_object_inline_y_4584=this.options.minScale,width="undefined"===typeof JSCompiler_object_inline_y_4584.x?null:JSCompiler_object_inline_y_4584.x,JSCompiler_object_inline_y_4584="undefined"===typeof JSCompiler_object_inline_y_4584.y?null:JSCompiler_object_inline_y_4584.y);"number"===typeof this.options.maxScale?
JSCompiler_object_inline_y_4586=height=this.options.maxScale:null!==this.options.maxScale&&(JSCompiler_object_inline_y_4586=this.options.maxScale,height="undefined"===typeof JSCompiler_object_inline_y_4586.x?null:JSCompiler_object_inline_y_4586.x,JSCompiler_object_inline_y_4586="undefined"===typeof JSCompiler_object_inline_y_4586.y?null:JSCompiler_object_inline_y_4586.y);let scaleX=this.parent.scale.x,scaleY=this.parent.scale.y;null!==width&&scaleX<width&&(scaleX=width);null!==height&&scaleX>height&&
(scaleX=height);null!==JSCompiler_object_inline_y_4584&&scaleY<JSCompiler_object_inline_y_4584&&(scaleY=JSCompiler_object_inline_y_4584);null!==JSCompiler_object_inline_y_4586&&scaleY>JSCompiler_object_inline_y_4586&&(scaleY=JSCompiler_object_inline_y_4586);if(scaleX!==this.parent.scale.x||scaleY!==this.parent.scale.y)this.parent.scale.set(scaleX,scaleY),this.parent.emit("zoomed",{viewport:this.parent,type:"clamp-zoom"})}}reset(){this.clamp()}}const DEFAULT_DECELERATE_OPTIONS={friction:.98,bounce:.8,
